...
public class DBHelper2 extends SQLiteOpenHelper {
        ...
        public static synchronized DBHelper2 getInstance(Context context){
            if(INSTANCE == null){
                INSTANCE = new DBHelper2(context.getApplicationContext());
            }
            return INSTANCE;
        }
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            public void onUpgrade(SQLiteDatabase db, int i, int i1) {
                    ...
                    String query = "SELECT " + EMPLOYEE_ID + ", " + EMPLOYEE_FIRST_NAME + ", " + EMPLOYEE_SECOND_NAME
    ...
    public Cursor bostonCompanies() {
        SQLiteDatabase db = getReadableDatabase();
        String query = "SELECT " + EMPLOYEE_ID + "," + EMPLOYEE_FIRST_NAME + ", " + EMPLOYEE_SECOND_NAME + " FROM "
                + EMPLOYEE_TABLE
                + " JOIN " + JOB_TABLE
                + " ON " + EMPLOYEE_TABLE + "." + EMPLOYEE_SSN + " = " + JOB_TABLE + "." + JOB_SSN
